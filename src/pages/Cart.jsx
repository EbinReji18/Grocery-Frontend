    ...
    <div className="flex flex-col md:flex-row mt-16">
      ...
      <div className="flex-1 max-w-4xl">
        <h1 className="text-3xl font-medium mb-6">
          Shopping Cart{" "}
          <span className="text-sm text-primary-500">{getCartCount()} Items</span>
        </h1>
        ...
        <button
          ...
          className="group cursor-pointer flex items-center mt-8 gap-2 text-primary-500 font-medium"
        >
          <img
